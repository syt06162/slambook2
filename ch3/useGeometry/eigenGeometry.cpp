...
int main(int argc, char** argv) {
    ...
    Vector3d v(1, 0, 0);
    cout << "start vector = (" << v.transpose() << ")" << endl;
    ...
    // yejoon: print Rotaion vector's axis, angle
    cout << "rotation axis = " << rotation_vector.axis().transpose() << endl;
    cout << "rotation angle = " << rotation_vector.angle() << " radians" << endl;


    // ------ 2. rotation matrix ------
    cout << "------ 2. rotation matrix ------" << endl;
    ...
    // yejoon::    w:real
    // q.coeffs().transpose() -> (x, y, z, w) 
    // but, Quaterniond q(w, x, y, z)
